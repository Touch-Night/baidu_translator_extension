...
def input_modifier(string):
    ...
    return fanyi.translate_text(string, from_=params['language string'], to=fanyi.Lang.EN)
...
def output_modifier(string):
    ...
    return fanyi.translate_text(string, from_='en', to=params['language string'])
...
def ui():
    ...
    with gr.Row():
        language = gr.Dropdown(value=language_name, choices=[k for k in language_codes], label='你使用的语言')
